...
instructions: store the archive and run auditory.py (you don't have to cd into the
...
COMPUTER SIMULATIONS OF SENSORY SYSTEMS -- COCHLEAR IMPLANTS
"""
...
def get_file():
    ...
    root.filename = filedialog.askopenfilename(
        initialdir=os.curdir, title="Select file", filetypes=(("sound files", ("*.wav", "*.mp3")), ("all files", "*.*")))
